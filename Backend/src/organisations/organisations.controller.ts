import { Controller, Get, Patch, Body, Param, Query, UseGuards, ParseUUIDPipe, HttpCode, HttpStatus } from '@nestjs/common';
import { ApiTags, ApiBearerAuth, ApiOperation, ApiOkResponse, ApiNotFoundResponse, ApiForbiddenResponse, ApiQuery } from '@nestjs/swagger'
...
export class OrganisationsController {
    ...
    @Get(':id')
    @ApiOperation({ summary: 'Get a single organisation with its products (public)' })
