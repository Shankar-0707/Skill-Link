...
export const LandingNavbar: React.FC = () => {
  ...
  return (
    <div className="fixed top-4 left-0 right-0 z-50 flex justify-center px-4 sm:px-10 lg:px-16">
      <nav className="w-full max-w-340 flex items-center justify-between py-4 backdrop-blur-md bg-white/50 border border-white/60 rounded-full px-6 md:px-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
